...
import { generateDirectorySEO } from '../utils/seoUtils';
...
const Directory = () => {
  ...
  const handleToggleAnalytics = () => {
    ...
    const seoData = generateDirectorySEO(getCurrentFilters(), advisors, totalResults);
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <SEOHelmet
         ...
         url={`/directory${typeof window !== 'undefined' ? window.location.search : ''}`}
         type="website"
